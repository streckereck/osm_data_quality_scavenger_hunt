...
# doing most of the editing on the main branch for convenience...
...
_ [Humanitarian OpenStreetMap Team](https://www.hotosm.org/)
...
- **`r colorize("Green", "#40AC8C")`** means done
- **`r colorize("Turquoise", "#ADE6EF")`** means ready of validation
- **`r colorize("Grey", "grey")`** mean unavailable
- **`r colorize("Yellow", "#FCECA4")`** means more work needed
...
- If you pick one beside a completed tile, you can scroll over to see what it looks like when it's done.
